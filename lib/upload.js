...
Upload.prototype.checkForeignKeys = function () {
    ...
    var mkdir = Q.nbind(fs.mkdir, fs)(uploadDataPath);

    var writeCsvs = Q.all(self.datapackage.resources.map(function (resource) {
    ...
    return mkdir
        ...
        .finally(function (e) {
            rimraf(uploadDataPath, function (err) {
                console.log('removed temp upload directory');
            });
        })
        .catch(function (e) {
            console.log(e);
